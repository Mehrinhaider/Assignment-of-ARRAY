...
let lastfruits:string[]=["apple","banana","mango","orange","grapes"];
lastfruits.pop();
...
//named firstfruit
let firstfruit:string[]=["apple","banana","mango","orrange"];
firstfruit.shift();
...
let fruit3:string[]=["apple","bnana","mango","orange"];
fruits.splice(1,2);
console.log(fruit3);
...
let fruitSS:string[]=["apple","mango","banana","orange"];
